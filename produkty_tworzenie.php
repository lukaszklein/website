...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($name_err) && empty($cat_err) && empty($desc_err) && empty($img_err) && empty($imgmini_err)){
        ...
        $sql = "INSERT INTO produkty (nazwa, kategoria_id, opis, img, imgmini) VALUES (?, ?, ?, ?, ?)";
         
        if($stmt = mysqli_prepare($polaczenie, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sisss", $param_name, $param_cat, $param_desc, $param_img, $param_imgmini);
            ...
            <div class="row">
                ...
                <div class="col-sm-4" align=center>
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <input type="submit" class="btn btn-primary" value="Stworz">
